...
import { SaveHandlerProvider } from '@sim/engine/editor/lib/save-context';
import { UnsavedChangesProvider } from '@sim/engine/editor/lib/unsaved-changes';
import type { EditorDataHandle } from '@sim/engine/editor/lib/use-editor-data';

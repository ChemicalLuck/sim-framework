declare module 'virtual:game-extensions' {
  ...
  import type { EffectHydrator } from '@sim/engine/data/effect-hydrators';
  import type { EffectHandler, PostEffectHandler } from '@sim/engine/state/thunks';
  import type { EngineStore, RootState } from '@sim/engine/state/store';
...
declare module 'virtual:game-setup' {
  import type { Content } from '@sim/engine/data';
...
declare module 'virtual:conditions' {
  import type { Condition, Expr } from '@sim/engine/types';
